...
<div wire:poll.4s="nextSlide" class="mt-10 mx-auto flex flex-col items-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 ">
    ...
    @if (count($books) > 0)
        <!-- Kotak 16:9 -->
        <div class="relative w-full sm:w-[680px] aspect-[16/9] overflow-hidden shadow-lg  bg-gray-200 border border-gray-300">
            <div class="absolute inset-0 flex">
                ...
                <!-- Judul kanan -->
                <div class="w-1/2 p-4 flex flex-col justify-center bg-gray-400">
                    <h2 class="text-2xl font-semibold text-white">{{ $books[$currentIndex]->nama_buku }}</h2>
                </div>
            </div>
        </div>
