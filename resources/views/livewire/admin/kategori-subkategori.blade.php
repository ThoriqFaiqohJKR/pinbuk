<div>
    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-8 lg:px-40 xl:px-48 py-8">
        <div class="w-full">
            <!-- Breadcrumb Card with improved level style -->
            <div
                class="flex items-center space-x-6 select-none"
                role="navigation"
                aria-label="Breadcrumb">
                <!-- Kategori Utama as box -->
                <div
                ...
                <div
                    ...
                    <div
                        class="flex items-center justify-center w-12 h-12  bg-blue-100 text-blue-700 font-bold select-none"
                        aria-hidden="true">
                    ...
                    <span class="text-gray-800 text-lg font-semibold truncate pr-4">
                        {{ $subkategori1Nama ?? "Subkategori 1" }}
                    </span>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap gap-4">
                    @forelse ($sub2 as $sub)
                    <a href="{{ url('/admin/buku/kategori-buku/' . $kategoriId . '/subkategori/' . $subkategoriId . '/sub2/' . $sub->id) }}"
                        ...
                        <span class="text-gray-800 font-medium">{{ $sub->nama }}</span>
                    </a>
                    @empty
                    <p class="text-gray-500">Tidak ada subkategori 2.</p>
                    @endforelse
                </div>
            </div>
            ...
            <h3 class="font-semibold py-2">📘 Daftar Buku:</h3>
