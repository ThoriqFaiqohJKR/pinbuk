<div>
  ...
  <div>
    ...
    <div wire:poll.5s="nextSlide" class="mt-10 mx-auto flex flex-col items-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 ">
      ...
      @if (count($books) > 0)
      <!-- Kotak 16:9 -->
      <a href="{{ route('user.buku.detail', ['id' => $books[$currentIndex]->id]) }}" class="block w-full sm:w-[680px] mx-auto px-4">
        ...
        <div class="aspect-[16/9] bg-white shadow-lg border border-gray-300 flex overflow-hidden">
          ...
          <!-- Teks -->
          <div class="w-1/2 p-4 flex flex-col p-0 sm:p-7 mt-12">
      ...
      <!-- Caption bawah -->
      <h3 class="font-semibold text-xs text-black mt-2 text-left w-full sm:w-[680px] px-4">
        {{ $books[$currentIndex]->nama_buku }}
      </h3>
          ...
          <div
            ...
            @if($buku->total_stok < 1)
              ...
              <a
                ...
                class="border aspect-square w-48 flex-shrink-0 bg-white border-abu shadow-sm h-48 flex flex-col transform transition-transform duration-200 hover:scale-100 hover:shadow-md hover:border-auriga">
                @endif
