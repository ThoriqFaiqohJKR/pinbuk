...
<body class="font-roboto bg-gray-100">
  <nav class="bg-black shadow-md fixed w-full sm:px-[179px] z-50" x-data="{ open: false }">
    <div class="mx-auto">
      <div class="flex justify-between h-16">
        ...
        <div class="flex">
          <div class="hidden sm:flex">
            ...
            <a class="nav-link text-white hover:text-gray-800 inline-flex items-center px-4 pt-1 pb-2 text-sm font-medium hover:bg-white" href="/admin/aset">
              Aset
            </a>
